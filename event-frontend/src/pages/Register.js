...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.data.user.role === 'ORGANIZER') navigate('/organizer/events');
    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
      <div style={{ width: '100%', maxWidth: 440 }} className="fade-up">
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <p style={{ color: 'var(--text-dim)' }}>Join EventHub and start discovering events</p>
        </div>
        ...
        <div className="card">
          ...
          <p style={{ color: 'var(--text-dim)', fontSize: 14, marginTop: 20, textAlign: 'center' }}>
